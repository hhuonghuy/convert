			...
			<header>
				...
				<ul className="nav">
					...
					<div className="dropdown">
						<button className="dropdown-btn" style={{ color: '#e9801f' }}>
							Sản Phẩm
							<i className="fa-solid fa-arrow-down" style={{ fontSize: 15 }} />
						</button>
						<div className="dropdown-content rounded-2">
							<a href="#">Sản phẩm áo</a>
							<a href="#">Sản phẩm quần</a>
							<a href="#">Phụ kiện</a>
						</div>
					</div>
					<li className="hover">
